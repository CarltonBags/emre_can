  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 text-[17px] leading-[1.75] text-foreground/85 sm:px-6">
        ...
        <p className="my-5">
          Die Farbwelt kommt vom Heimtrikot der Saison 1993/94: Neongelb,
          V-Kragen, Nike, Continentale auf der Brust – und diese zerrissene
          schwarze Grafik, die über Schulter und Ärmel lief. Keine gleichmäßigen
          Streifen, sondern Balken in unterschiedlicher Länge und Stärke, mit
          Lücken dazwischen. Genau so sind die Flächen hier auf der Seite
          gebaut. Das Trikot, in dem diese Mannschaft losgelaufen ist, bevor
          1995 alles anders wurde.
        </p>
        <p className="my-5">
