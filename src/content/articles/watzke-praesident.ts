...
const article: Article = {
  slug: "watzke-praesident",
  kicker: "Mitgliederversammlung",
  title: "Zwanzig Jahre Watzke",
  subtitle: "Aus der Geschäftsführung raus, ins Präsidentenamt rein",
  date: "2025-11-24",
  category: "Verein",
  tags: ["Watzke", "Präsident", "Vereinsgeschichte", "Insolvenz"],
  lede:
  ...
  body: `Ich war gestern nicht in den Westfalenhallen, sondern habe es zu Hause verfolgt, und trotzdem hat mich etwas an diesen Bildern angefasst.
